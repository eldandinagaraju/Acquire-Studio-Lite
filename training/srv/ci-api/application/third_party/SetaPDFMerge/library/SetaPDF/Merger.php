 ...
 * @version    $Id: Merger.php 1209 2018-05-28 09:24:19Z jan.slabon $
 */
...
class SetaPDF_Merger
{
     ...
     */
    protected $_maxFileHanlder = null;
        ...
        while ($currentObject->getValue()->offsetExists('Parent')) {
            ...
            if ($currentObject->getValue()->offsetExists('Kids')) {
                ...
                foreach ($kids as $key => $value) {
                    if ($lastObject->getObjectIdent() === $value->getObjectIdent()) {
