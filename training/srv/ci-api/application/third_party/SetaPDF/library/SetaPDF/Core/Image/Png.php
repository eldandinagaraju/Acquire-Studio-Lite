 ...
 * @version    $Id: Png.php 1199 2018-03-05 15:27:17Z jan.slabon $
 */
        ...
        if ($colorSpace === 3) {
            ...
            for ($i = 0, $h = $this->getHeight(); $i < $h; $i++) {
                ...
                for (; $offset < $lineEnd; $offset += 2) {
                    $colorImageBuffer .= fgetc($this->_imageData);
                    $alphaImageBuffer .= fgetc($this->_imageData);
                }
            ...
            for ($i = 0, $h = $this->getHeight(); $i < $h; $i++) {
                ...
                for (; $offset < $lineEnd; $offset += 4) {
                    $colorImageBuffer .= fread($this->_imageData, 3);
                    $alphaImageBuffer .= fgetc($this->_imageData);
                }
