...
|
*/
$config['auth_override_class_method']['typeform']['typeforms'] = 'none';
// $config['auth_override_class_method']['deals']['view'] = 'none';
// $config['auth_override_class_method']['deals']['insert'] = 'digest';
// $config['auth_override_class_method']['accounts']['user'] = 'basic';
...
API_AUTH_ID => API_AUTH_PWD,
'principal' => 'L!53@Pr!nc!p@l',
'statefarm' => 'mg5N)8(tf`{}R7@%');
/*
|--------------------------------------------------------------------------
...
$config['allowed_cors_domains'] = ['localhost:3000', 'localhost:3090', 'editor.swagger.io'];
